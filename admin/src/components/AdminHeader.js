...
export default function AdminHeader() {
  ...
  const navItems = [
    ...
    { name: 'Student Selection Lists', href: '/students', icon: Users },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 text-xs font-medium text-rose-400 hover:text-rose-300 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/30 px-3 py-1.5 rounded-md transition-all"
            >
