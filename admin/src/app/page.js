  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-950">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Login Box */}
        <div className="glass-panel p-8 shadow-2xl border border-slate-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full btn-gold py-3 flex items-center justify-center space-x-2 text-sm font-bold shadow-lg disabled:opacity-50"
            >
